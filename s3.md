In order to upload files you will need python and pip. We suggest you use homebrew for fairly quick and easy installation. 
...
```
Written by Laura Newman Eckstein with help from Sean Fern. 
